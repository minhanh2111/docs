...
<Tip>
  **<Tooltip tip="">Universal Object</Tooltip>** là miếng lego trung tâm, là trái tim giúp chuẩn hóa 100% dữ liệu của doanh nghiệp. Tất cả chung một bể dữ liệu, cùng ngôn ngữ, có thể khai thác sử dụng lâu dài cho nhiều mục đích.
</Tip>