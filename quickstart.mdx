...
# Toàn cảnh kiến trúc hệ thống LUKLAK
...
<Tip>
  **Universal Object** là miếng lego trung tâm, là trái tim giúp chuẩn hóa 100% dữ liệu của doanh nghiệp. Tất cả chung một bể dữ liệu, cùng ngôn ngữ, có thể khai thác sử dụng lâu dài cho nhiều mục đích.
</Tip>

<iframe src="https://www.guidejar.com/embed/3tfJg2mj2HIHiEmYA5A8?type=1&controls=on" width="100%" height="100%" style="position:absolute;inset:0" allowfullscreen frameborder="0"></iframe>